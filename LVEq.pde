...
final int PREDATOR_NUM=50,PREY_NUM=1000 ,PLANT_NUM=500,MAX_PREDATOR_NUM=1000,MAX_PREY_NUM=10000,MAX_PLANT_NUM=500;
...
void setup(){
  ...
  for(int i=0;i<PREY_NUM;i++)prey[i]=new Prey(random(0,Prey.MAX_AGE),random(10,100),random(10,100),random(2,4),true,random(.4,.8),random(10,14),new Vector(random(0,(double)width),random(0,(double)height)));
  ...
  for(int i=PREDATOR_NUM;i<MAX_PREDATOR_NUM;i++)predator[i]=new Predator(random(0,Predator.MAX_AGE),random(10,100),random(10,100),random(3,5),false,random(.4,.8),random(10,14),new Vector(random(0,(double)width),random(0,(double)height)));
...
void keyPressed(){
  ...
  println("Prey : "+preyAlive() + "\tHungry : " + preyHungry() + "\tStarving : " +preyStarving()+"  " +prey[smallprey()].getAge()+" "+smallprey() );
  println("Plant : "+plantAlive()+"  "+plant[0].getAge());
  println();
}
