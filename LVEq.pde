...
void setup(){
  ...
  for(int i=PREDATOR_NUM;i<PREDATOR_NUM*ARRAY_SIZE;i++)predator[i]=new Predator(random(0,Predator.MAX_AGE),random(10,100),random(10,100),random(3,5),false,random(.04,.08),random(.8,1.2),new Vector(random(0,(double)width),random(0,(double)height)));
  for(int i=PREY_NUM;i<PREY_NUM*ARRAY_SIZE;i++)prey[i]=new Prey(random(0,Prey.MAX_AGE),random(10,100),random(10,100),random(2,4),false,random(.04,.08),random(.8,1.2),new Vector(random(0,(double)width),random(0,(double)height)));
