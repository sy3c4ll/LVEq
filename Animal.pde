public class Animal{
  ...
  public void update(){this.p.add(PVector.mult(this.v,FRAMEDEPENDENCY?millis()-this.CLOCK:frameCount-this.CLOCK));this.CLOCK=FRAMEDEPENDENCY?millis():frameCount;this.grow();this.display();}
