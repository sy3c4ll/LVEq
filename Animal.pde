public class Animal extends Life{
  ...
  public Vector v;
  public Animal(double age,double org,double hunger,double size,boolean alive,double walkingspeed,double runningspeed,Vector p){super(age,size,alive,p);this.hunger=hunger;this.org=org;this.WALKING_SPEED=walkingspeed;this.RUNNING_SPEED=runningspeed;this.v=Vector.random2D();this.v.limit((double)walkingspeed);}
