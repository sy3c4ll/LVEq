public class Animal{
  private float hunger,SIZE,MAX_SPEED;
  private boolean alive;
  private PVector p,v,a;
  private int CLOCK;
  public Animal(float hunger,float size,float maxspeed,boolean alive,PVector p){this.hunger=hunger;this.SIZE=size;this.MAX_SPEED=maxspeed;this.alive=alive;this.p=p;this.v=new PVector(0,0);this.a=new PVector(0,0);this.CLOCK=millis();}
  public Animal(float hunger,float size,float maxspeed,boolean alive,PVector p,PVector v){this.hunger=hunger;this.SIZE=size;this.MAX_SPEED=maxspeed;this.alive=alive;this.p=p;this.v=v;this.a=new PVector(0,0);this.CLOCK=millis();}
  public Animal(float hunger,float size,float maxspeed,boolean alive,PVector p,PVector v,PVector a){this.hunger=hunger;this.SIZE=size;this.MAX_SPEED=maxspeed;this.alive=alive;this.p=p;this.v=v;this.a=a;this.CLOCK=millis();}
  ...
  public void update(){this.p.add(PVector.mult(this.v,FRAMEDEPENDENCY?1:millis()-this.CLOCK));this.v.add(PVector.mult(this.a,FRAMEDEPENDENCY?1:millis()-this.CLOCK));this.v.limit(MAX_SPEED);this.CLOCK=millis();}
