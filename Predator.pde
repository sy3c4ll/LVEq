public class Predator extends Animal{
  public static final float GROWTH=1;
  public static final float DANGER_HUNGER=30,MAX_AGE=20;
  public Predator(float age,float org,float hunger,float size,boolean alive,float walkingspeed,float runningspeed,PVector p){super(age,org,hunger,size,alive,walkingspeed,runningspeed,p);}
