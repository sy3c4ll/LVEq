 public class Predator extends Animal{
  public static final double GROWTH=1000, BIRTH_CYCLE=2;
...
true,1,80000, new Vector(max(min((this.p.x+random(-30,30)),width),0),max(min((this.p.y+random(-30,30)),height),0)));}}}}
  @Override public void metabolism(){if(this.hunger>0){this.hunger-=(5000+Predator.GROWTH)*this.regulate()*Life.FRAMEHOUR;this.org+=Predator.GROWTH*this.regulate();}else{this.org-=5000*this.regulate()*Life.FRAMEHOUR;}}
